...
Sub CreateCoordinatorTabs()
    ...
    For Each coordName In coordKeys
        ...
        If ws Is Nothing Then
            ' Use the reusable function to create a new tab
        ...
        SetAliasInNewTab newTab, COORDINADORES_TABLE, ALIAS_COLUMN, NOMBRE_COLUMN, coordName, "Unknown Coordinator"
    Next coordName
    ...
    For Each coordName In coordKeys
        ...
        SetTableName newTable, coordName, "Tabla_Coordinador_"
