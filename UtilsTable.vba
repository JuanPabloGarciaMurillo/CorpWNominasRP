...
'==================================================
Public Sub SortTableAlphabetically(ByVal table As ListObject, ByVal columnIndex As Long)
    With table.Sort
        .SortFields.Clear
...
'==================================================
Public Sub PopulateTableWithCollection(ByVal table As ListObject, ByVal data As Collection)
    Dim item As Variant
    Dim newRow As ListRow
    For Each item In data
        Set newRow = table.ListRows.Add
        newRow.Range(1, 1).Value = item
    Next item
End Sub